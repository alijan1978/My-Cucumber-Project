...
// calling the below global as class level:
...
// Another request making with json payload
    ...
    @Then("the status code for employee is {int}")
    public void the_status_code_for_employee_is(Integer int1) {
//  argument or value of int1 (201) is coming from APIWorkflow.feature file
...
//  hamcrest Matchers equalTo() to verify the exact data comparing
...
//  Storing the employee id in global variable, this path of employee id is coming from feature file
